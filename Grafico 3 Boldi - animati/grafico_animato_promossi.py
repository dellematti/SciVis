...
#Creazione lista (list_percentuali) di % dei promossi dal 2019 al 2022:
...
def animate(i):
    ...
    ax.set_title('Grafico degli studenti promossi per ogni A.A.')
