...
print("\nRisultati degli studenti del 2018 2019 :\n")   
iscritti = stampaDati(voti16_17)                                   #stampa il numero di studenti per ogni risultato ( di un certo anno)
strOutput += str(iscritti)
strOutput += ' '
print("\nRisultati degli studenti del 2019 2020 :\n")   
iscritti = stampaDati(voti17_18)                                   #stampa il numero di studenti per ogni risultato ( di un certo anno)
strOutput += str(iscritti)
strOutput += ' '
print("\nRisultati degli studenti del 2020 2021 :\n")   
iscritti = stampaDati(voti18_19)                                   #stampa il numero di studenti per ogni risultato ( di un certo anno)
strOutput += str(iscritti)
strOutput += ' '
print("\nRisultati degli studenti del 2021 2022 :\n")   
iscritti = stampaDati(voti19_20)                                   #stampa il numero di studenti per ogni risultato ( di un certo anno)
strOutput += str(iscritti)
#print("\nRisultati degli studenti del 2020 2021 :\n")   
...
with open('iscritti.txt', 'w') as fileOut:
