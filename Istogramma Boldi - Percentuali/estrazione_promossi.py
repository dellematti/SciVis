...
print("\nRisultati degli studenti del 2018 2019 :\n")   
promossi = stampaDati(voti16_17)                                   #stampa il numero di studenti per ogni risultato ( di un certo anno)
strOutput += str(promossi)
strOutput += ' '
print("\nRisultati degli studenti del 2019 2020 :\n")   
promossi = stampaDati(voti17_18)                                   #stampa il numero di studenti per ogni risultato ( di un certo anno)
strOutput += str(promossi)
strOutput += ' '
print("\nRisultati degli studenti del 2020 2021 :\n")   
promossi = stampaDati(voti18_19)                                   #stampa il numero di studenti per ogni risultato ( di un certo anno)
strOutput += str(promossi)
strOutput += ' '
print("\nRisultati degli studenti del 2021 2022 :\n")   
promossi = stampaDati(voti19_20)                                   #stampa il numero di studenti per ogni risultato ( di un certo anno)
strOutput += str(promossi)
#print("\nRisultati degli studenti del 2020 2021 :\n")   
...
print('\nPercentuali 19/20: ')
for idx, percentuale in enumerate (percentuali17_18) :      #questo stampa le percentuali
    print(idx+17, "{:.2f}".format(percentuale*100))

print('\nPercentuali 20/21: ')
for idx, percentuale in enumerate (percentuali18_19) :      #questo stampa le percentuali
    print(idx+17, "{:.2f}".format(percentuale*100))

print('\nPercentuali 21/22: ')
for idx, percentuale in enumerate (percentuali19_20) :      #questo stampa le percentuali
    print(idx+17, "{:.2f}".format(percentuale*100))
...
with open('passati.txt', 'w') as fileOut:
