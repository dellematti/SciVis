...
text = extract_text("Risultati 21-22.pdf")
#print(text)
...
for i in str_new:
    if i.isnumeric() or i == "Insuff" or i == "R" or i == 'P' or i.__contains__(',') or i.__contains__("Insuff") or i.__contains__('R') or i.__contains__('A') or i.__contains__('P'):
        #print(i)
        stringa_voti += i
        stringa_voti += '-'
...
contaInsuff = 0
for i in vettore_voti_finale:
    if i != 'A' and i != 'R' and i.__contains__('A') == False and i.__contains__('R') == False and i.__contains__('P') == False:
        if int(i) < 17:
            contaInsuff += 1
    if i.__contains__('P') or i == 'P':
        contaInsuff += 1
