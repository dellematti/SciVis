...
with open('percentuali_bocciati.txt') as file:
...
mesi = ["Gennaio", "Settembre", "Luglio",  "Giugno", "Febbraio"]
...
nove = [list_2019_int[0], list_2019_int[4], list_2019_int[3], list_2019_int[2], list_2019_int[1], list_2019_int[0]]    
venti = [list_2020_int[0], list_2020_int[4], list_2020_int[3], list_2020_int[2], list_2020_int[1], list_2020_int[0]]
ventuno = [list_2021_int[0], list_2021_int[4], list_2021_int[3], list_2021_int[2], list_2021_int[1], list_2021_int[0]]
ventidue = [list_2022_int[0], list_2022_int[4], list_2022_int[3], list_2022_int[2], list_2022_int[1], list_2022_int[0]]
...
#plt.title("Bocciati anni 2019 2020 2021")
# csfont = {'fontname':'Trebuchet MS'}
csfont = {'fontname':'Times New Roman'}
#plt.title('title',**csfont)
plt.title(label="Percentuali di studenti bocciati per ogni appello ", fontsize= 18,**csfont, fontweight="bold", color="black", pad='26.0')  #,fontweight=102,  pad è lo spazio sotto
